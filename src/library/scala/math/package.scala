...
/** The package object `scala.math` contains mathemamatical constants and
 *  methods for performing basic numeric operations such as rounding,
...
package object math {
   ...
   *
   *  @param  x a floating-point value to be rounded to an `Int`.
   ...
   *
   *  @param  x a floating-point value to be rounded to an `Long`.
