...
object Platform {
  ...
  /** Thrown when a stack overflow occurs because an application recurses too deeply.
    *
    * This is a type alias for ''java.lang.StackOverflowError'', which itself extends ''java.lang.Error''.
  ...
  /** Returns the Class object associated with the class or interface with the given string name using the current ClassLoader. This uses [[java.lang.Class#forName]].
   *  Invoking this method is equivalent to: {{{java.lang.Class.forName(name)}}}
   *
   ...
   * 
   * This is equivalent to calling the java method:
