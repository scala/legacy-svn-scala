...
// was based on an example with MIT License, included in xerces distrib
    ...
    implements ContentHandler, ErrorHandler // SAX2
{
     ...
     */
    public abstract boolean elementContainsText(String localName);
     ...
     */
    public abstract scala.Object createElement(String elemName, 
                                        Map attribs, 
                                        Iterator chIter);
     ...
     */
    public abstract scala.Object createPCDATA(String text);
