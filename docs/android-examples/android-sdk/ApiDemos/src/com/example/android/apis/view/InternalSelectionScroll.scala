...
class InternalSelectionScroll extends Activity {
  ...
  override protected def onCreate(savedInstanceState: Bundle) {
    ...
    val svLp = new /*ScrollView*/ViewGroup.LayoutParams(
    ...
    val isv = new InternalSelectionView(this, 10)
    val screenHeight = getWindowManager.getDefaultDisplay.getHeight
    val llLp = new LinearLayout.LayoutParams(
                ViewGroup.LayoutParams.FILL_PARENT,
