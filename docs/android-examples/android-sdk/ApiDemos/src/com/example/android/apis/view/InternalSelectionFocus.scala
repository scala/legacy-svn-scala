 ...
 */
class InternalSelectionFocus extends Activity {
  ...
  override protected def onCreate(savedInstanceState: Bundle) {
    ...
    val params = new LinearLayout.LayoutParams(0,
                ViewGroup.LayoutParams.FILL_PARENT, 1)

    val leftColumn = new InternalSelectionView(this, 5, "left column")
    leftColumn.setLayoutParams(params)
    leftColumn.setPadding(10, 10, 10, 10)
    layout addView leftColumn

    val middleColumn = new InternalSelectionView(this, 5, "middle column")
    middleColumn.setLayoutParams(params)
    middleColumn.setPadding(10, 10, 10, 10)
    layout addView middleColumn

    val rightColumn = new InternalSelectionView(this, 5, "right column")
