 ...
 */
class SaveRestoreState extends Activity {
  /**
  ...
  override protected def onCreate(savedInstanceState: Bundle) {
    ...
    val tv = findViewById(R.id.msg).asInstanceOf[TextView]
    tv setText R.string.save_restore_msg
  }

  /**
   * Retrieve the text that is currently in the "saved" editor.
   */
  def getSavedText(): CharSequence =
    findViewById(R.id.saved).asInstanceOf[EditText].getText

  /**
   * Change the text that is currently in the "saved" editor.
   */
  def setSavedText(text: CharSequence) {
    findViewById(R.id.saved).asInstanceOf[EditText] setText text
  }
}
