...
import android.preference.{CheckBoxPreference, EditTextPreference,
...
class PreferencesFromCode extends PreferenceActivity {
  ...
  private def createPreferenceHierarchy(): PreferenceScreen = {
    ...
    // Inline preferences 
    val inlinePrefCat = new PreferenceCategory(this)
    inlinePrefCat setTitle R.string.inline_preferences
    root addPreference inlinePrefCat

    // Toggle preference
    val togglePref = new CheckBoxPreference(this)
    ...
    val dialogBasedPrefCat = new PreferenceCategory(this)
    dialogBasedPrefCat setTitle R.string.dialog_based_preferences
    root addPreference dialogBasedPrefCat

    // Edit text preference
    val editTextPref = new EditTextPreference(this)
    ...
    // List preference
    val listPref = new ListPreference(this)
    ...
    // Launch preferences
    val launchPrefCat = new PreferenceCategory(this)
     ...
     */
    // Screen preference
    val screenPref = getPreferenceManager.createPreferenceScreen(this)
    ...
    val nextScreenCheckBoxPref = new CheckBoxPreference(this)
    ...
    // Intent preference
    val intentPref = getPreferenceManager.createPreferenceScreen(this)
    ...
    val prefAttrsCat = new PreferenceCategory(this)
    prefAttrsCat setTitle R.string.preference_attributes
    root addPreference prefAttrsCat

    // Visual parent toggle preference
    val parentCheckBoxPref = new CheckBoxPreference(this)
    ...
    val childCheckBoxPref = new CheckBoxPreference(this)
