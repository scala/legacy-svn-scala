...
object SearchSuggestionSampleProvider {
   ...
   */
  final val AUTHORITY = "com.example.android.apis.SuggestionProvider"
  /**
   ...
   */
  final val MODE = SearchRecentSuggestionsProvider.DATABASE_MODE_QUERIES
}

class SearchSuggestionSampleProvider extends SearchRecentSuggestionsProvider {
  import SearchSuggestionSampleProvider._  // companion object
