...
object LauncherShortcuts {
  private final val EXTRA_KEY = "com.example.android.apis.app.LauncherShortcuts"
}

class LauncherShortcuts extends Activity {
  import LauncherShortcuts._  // companion object
  ...
  override def onCreate(icicle: Bundle) {
    ...
    val intentInfo = findViewById(R.id.txt_shortcut_intent).asInstanceOf[TextView]
   ...
   * 
   * The first intent serves as a container for the shortcut and is returned to
   * the launcher by setResult().  This intent must contain three fields:
   * 
   * <ul>
   * <li>{@link android.content.Intent#EXTRA_SHORTCUT_INTENT} The shortcut intent.</li>
   * <li>{@link android.content.Intent#EXTRA_SHORTCUT_NAME} The text that will be displayed with
   * the shortcut.</li>
   * <li>{@link android.content.Intent#EXTRA_SHORTCUT_ICON} The shortcut's icon,
   * if provided as a bitmap, <i>or</i> {@link android.content.Intent#EXTRA_SHORTCUT_ICON_RESOURCE} if provided as
   ...
   * your content, but any Intent will work here as
   * long as it triggers the desired action within your Activity.
   */
  private def setupShortcut() {
    ...
    val shortcutIntent = new Intent(Intent.ACTION_MAIN)
